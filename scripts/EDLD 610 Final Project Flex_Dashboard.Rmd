...
p_3 <- ggplot(median_top_20, aes(fct_reorder(major, median), median)) +
...
ggplot(plot_2_c, aes(unemployment_rate_percentage, percent_college_jobs, color = major_category))+
  ...
  labs(x = "Unemployment Rate",
       ...
       title = "Comparison of Unemployment Rate to College Major Employment Rate",
